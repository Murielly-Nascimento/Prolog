/*E. 5 Escreva um predicado pop_elevada(Continente, Lista) que calcule a lista de todos os
paı́ses com mais de 15 milhões de habitantes de um dado continente, ordenada por ordem
crescente de população, no formato indicado.*/
