/*E. 6 Escreva um predicado isolados_grandes(Lista) que calcule a lista, ordenada por ordem
alfabética, de todos os continentes que possuem pelo menos dois paı́ses que tenham simul-
taneamente uma populaçã*/
